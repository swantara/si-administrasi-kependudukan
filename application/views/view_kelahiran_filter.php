        ...
        <div class="col-md-12">
          ...
          <div class="box box-danger">
            <div class="box-header with-border">
              ...
              <a href="<?=site_url('kelahiran')?>" class="btn btn-default"><i class="fa fa-arrow-left"></i> Kembali</a>
  ...
  <script>
    ...
    function filter()
    {
      ...
      $.post( "http://localhost/si-administrasi-kependudukan/index.php/kelahiran/pencarianservice/", 
      { 
        no_kk: $('#no_kk').val(),
        nik: $('#nik').val(),
