        ...
        <div class="col-md-12">
          ...
          <div class="box box-danger">
            <div class="box-header with-border">
              ...
              <a href="<?=site_url('kematian')?>" class="btn btn-default"><i class="fa fa-arrow-left"></i> Kembali</a>
            ...
            <div class="box-body">
              ...
              <div class="row">
                <div class="col-md-3">
                  <div class="form-group">
                    <small>Tanggal Meninggal</small><br>
                    <div class='input-group date'>
                      <div class='input-group-addon'>
                        <i class='fa fa-calendar'></i>
                      </div>
                      <input name="tanggal_meninggal" type='text' class='form-control pull-right input-sm' id='kedatangan_datepicker' value="<?=set_value('tanggal_meninggal')?>">
                    </div>
                  </div>
                </div>                
                <div class="col-md-3">
                  <div class="form-group">
                    <small>Tempat Meninggal</small>
                    <input name="tempat_meninggal" id="tempat_meninggal" type="text" class="form-control input-sm" value="<?=set_value('tempat_meninggal')?>" placeholder="Tempat Meninggal">
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                    <small>Penyebab Meninggal</small>
                    <input name="penyebab_meninggal" id="penyebab_meninggal" type="text" class="form-control input-sm" value="<?=set_value('penyebab_meninggal')?>" placeholder="Penyebab Meninggal">
                  </div>
                </div>
              </div>
            </div>
  ...
  <script>
    ...
    function filter()
    {
      ...
      if($('#kedatangan_datepicker').val() != ""){
        tag.html(tag.html() + " Tanggal Kematian : <u>" + $('#kedatangan_datepicker').val() + "</u>, ");
      }
      if($('#tempat_meninggal').val() != ""){
        tag.html(tag.html() + " Tempat Meninggal : <u>" + $('#tempat_meninggal').val() + "</u>, ");
      }
      if($('#penyebab_meninggal').val() != ""){
        tag.html(tag.html() + " Penyebab Meninggal : <u>" + $('#penyebab_meninggal').val() + "</u>, ");
      }
      tag.html(tag.html().substr(0, tag.html().length - 2));
      if($('#no_kk').val() == "" && $('#nik').val() == "" && $('#nama_penduduk').val() == "" && $('#periode').val() == "" && $('#status_kk').val() == "" && $('#tempat_lahir').val() == "" && $('#datepicker').val() == "" && jk == "2" && $('#alamat').val() == "" && $('#agama').val() == "" && $('#pendidikan').val() == "" && $('#pekerjaan').val() == "" && $('#telepon').val() == "" && $('#nama_ayah').val() == "" && $('#nama_ibu').val() == "" && $('#status_kependudukan').val() == "" && $('#status_kawin').val() == "" && $('#kewarganegaraan').val() == "" && $('#kedatangan_datepicker').val() == "" && $('#tempat_meninggal').val() == "" && $('#penyebab_meninggal').val() == ""){
        tag.html(tag.html() + " Menampilkan seluruh data kematian.");
      }
      // console.log($('#datepicker').val());
      $.post( "http://localhost/si-administrasi-kependudukan/index.php/kematian/pencarianservice/", 
      { 
        no_kk: $('#no_kk').val(),
        nik: $('#nik').val(),
        ...
        kematian_datepicker: $('#kedatangan_datepicker').val(),
        tempat_meninggal: $('#tempat_meninggal').val(),
        penyebab_meninggal: $('#penyebab_meninggal').val()
      })
      .done(function( datax ) {
          // console.log(datax);
